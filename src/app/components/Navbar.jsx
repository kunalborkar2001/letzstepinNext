        ...
        >
            <Menu setActive={setActive}>
                ...
                <MenuItem setActive={setActive} active={active} item="Categories">
                    <div className="text-sm grid gird-cols-1 md:grid-cols-2 gap-10 p-4 max-h-[50vh] overflow-y-auto">
                        <ProductItem
                            title="Fitness"
                            href="/fitness"
                            ...
                            description="Dive in the world of fitness"
                        />
                        <ProductItem
                            title="Banquet"
                            href="/banquet"
                            ...
                            description="The perfect venue for weddings, receptions, and corporate events"
                        />
                        <ProductItem
                            title="Real-Estate"
                            href="/realestate"
                            ...
                            description="Discover your dream home with our real estate services"
                        />
                        <ProductItem
                            title="Education"
                            href="education"
                            ...
                            description="Transform education with cutting-edge technology and resources"
                        />
                        <ProductItem
                            title="Hotels"
                            href="/hotels"
                            ...
                            description="Stay in comfort and luxury at our top-rated hotels"
                        />
                        <ProductItem
                            title="Co-Working"
                            href="/coworking"
                            ...
                            description="Discover the perfect workspace solution for your business at our co-working spaces"
                        />
                    </div>
                </MenuItem>
